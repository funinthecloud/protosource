...
const file_example_app_sample_v1_sample_v1_proto_rawDesc = "" +
	...
	"\x04body\x18\a \x01(\tR\x04body:\x05\x8aQ\x02\x1a\x00\"A\n" +
	"\n" +
	"SampleList\x123\n" +
	...
	"\x02at\x18\x03 \x01(\x03R\x02at\x12\x14\n" +
	"\x05actor\x18\x04 \x01(\tR\x05actor\x12\x12\n" +
	"\x04body\x18\x05 \x01(\tR\x04body:\x05\x8aQ\x02\x12\x00\"\x9e\x01\n" +
	"\bSnapshot\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x03R\aversion\x12\x0e\n" +
	"\x02at\x18\x03 \x01(\x03R\x02at\x12\x14\n" +
	"\x05actor\x18\x04 \x01(\tR\x05actor\x129\n" +
	"\bsnapshot\x18\x05 \x01(\v2\x1d.example.app.sample.v1.SampleR\bsnapshot:\a\x8aQ\x04*\x02\b2B\xef\x01\x92Q\x02\b\x01\n" +
	"\x19com.example.app.sample.v1B\rSampleV1ProtoP\x01ZGgithub.com/funinthecloud/protosource/gen/example/app/sample/v1;samplev1\xa2\x02\x03EAS\xaa\x02\x15Example.App.Sample.V1\xca\x02\x15Example\\App\\Sample\\V1\xe2\x02!Example\\App\\Sample\\V1\\GPBMetadata\xea\x02\x18Example::App::Sample::V1b\x06proto3"
