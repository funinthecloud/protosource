...
// "example.app.test.v1.{Operation}" where {Operation} is:
...
func (h *Handler) RegisterRoutes(router *protosource.Router) {
	...
	router.Handle("GET", "example/app/test/v1/load/{id}", h.HandleLoad)
...
// HandleLoad retrieves the current state of a Test aggregate by
...
func (h *Handler) HandleLoad(ctx context.Context, request protosource.Request) protosource.Response {
	ctx, err := h.authorizer.Authorize(ctx, request, "example.app.test.v1.LoadTest")
	if err != nil {
		return authzErrorResponse(request, err)
	}
...
// HandleGet retrieves the Test aggregate from the materialized store.
...
func (h *Handler) HandleGet(ctx context.Context, request protosource.Request) protosource.Response {
	ctx, err := h.authorizer.Authorize(ctx, request, "example.app.test.v1.GetTest")
	if err != nil {
		return authzErrorResponse(request, err)
	}
...
func (h *Handler) HandleHistory(ctx context.Context, request protosource.Request) protosource.Response {
	ctx, err := h.authorizer.Authorize(ctx, request, "example.app.test.v1.HistoryTest")
	if err != nil {
		return authzErrorResponse(request, err)
	}
...
func (h *Handler) HandleQueryByColor(ctx context.Context, request protosource.Request) protosource.Response {
	ctx, err := h.authorizer.Authorize(ctx, request, "example.app.test.v1.QueryByColor")
	if err != nil {
		return authzErrorResponse(request, err)
	}
	...
	if colorRaw == "" {
		return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_PK", "missing required parameter: color", nil)
	}
	color, colorErr := parseQueryParamString(colorRaw)
	if colorErr != nil {
		return errorResponse(request, http.StatusBadRequest, "QUERY_BAD_PARAM", fmt.Sprintf("invalid value for color: %v", colorErr), nil)
	}
	...
	if shapeRaw == "" {
		return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_SK", "missing required parameter: shape", nil)
	}
	shapeVal, shapeErr := parseQueryParamString(shapeRaw)
	if shapeErr != nil {
		return errorResponse(request, http.StatusBadRequest, "QUERY_BAD_PARAM", fmt.Sprintf("invalid value for shape: %v", shapeErr), nil)
	}
	...
	if op == opaquedata.Between {
		...
		if shapeRaw2 == "" {
			return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_SK", "missing required parameter: shape2 (required for between)", nil)
		}
		shapeVal2, shapeErr2 := parseQueryParamString(shapeRaw2)
		if shapeErr2 != nil {
			return errorResponse(request, http.StatusBadRequest, "QUERY_BAD_PARAM", fmt.Sprintf("invalid value for shape2: %v", shapeErr2), nil)
		}
		skVal2 := TestGSI1SK{
			Shape: shapeVal2,
		}
...
func (h *Handler) HandleQueryByColorWithNumber(ctx context.Context, request protosource.Request) protosource.Response {
	ctx, err := h.authorizer.Authorize(ctx, request, "example.app.test.v1.QueryByColorWithNumber")
	if err != nil {
		return authzErrorResponse(request, err)
	}
	...
	if numberRaw == "" {
		return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_SK", "missing required parameter: number", nil)
	}
	numberVal, numberErr := parseQueryParamString(numberRaw)
	if numberErr != nil {
		return errorResponse(request, http.StatusBadRequest, "QUERY_BAD_PARAM", fmt.Sprintf("invalid value for number: %v", numberErr), nil)
	}
	...
	if op == opaquedata.Between {
		...
		if numberRaw2 == "" {
			return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_SK", "missing required parameter: number2 (required for between)", nil)
		}
		numberVal2, numberErr2 := parseQueryParamString(numberRaw2)
		if numberErr2 != nil {
			return errorResponse(request, http.StatusBadRequest, "QUERY_BAD_PARAM", fmt.Sprintf("invalid value for number2: %v", numberErr2), nil)
		}
		skVal2 := TestGSI2SK{
			Number: numberVal2,
		}
...
func (h *Handler) HandleQueryByNumberAndShading(ctx context.Context, request protosource.Request) protosource.Response {
	ctx, err := h.authorizer.Authorize(ctx, request, "example.app.test.v1.QueryByNumberAndShading")
	if err != nil {
		return authzErrorResponse(request, err)
	}
	...
	numberRaw := request.QueryParameters["number"]
	if numberRaw == "" {
		return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_PK", "missing required parameter: number", nil)
	}
	...
	if shadingRaw == "" {
		return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_PK", "missing required parameter: shading", nil)
	}
	shading, shadingErr := parseQueryParamString(shadingRaw)
	if shadingErr != nil {
		return errorResponse(request, http.StatusBadRequest, "QUERY_BAD_PARAM", fmt.Sprintf("invalid value for shading: %v", shadingErr), nil)
	}
	...
	if create_byRaw == "" {
		return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_SK", "missing required parameter: create_by", nil)
	}
	create_byVal, create_byErr := parseQueryParamString(create_byRaw)
	if create_byErr != nil {
		return errorResponse(request, http.StatusBadRequest, "QUERY_BAD_PARAM", fmt.Sprintf("invalid value for create_by: %v", create_byErr), nil)
	}
	...
	if op == opaquedata.Between {
		...
		if create_byRaw2 == "" {
			return errorResponse(request, http.StatusBadRequest, "QUERY_MISSING_SK", "missing required parameter: create_by2 (required for between)", nil)
		}
		create_byVal2, create_byErr2 := parseQueryParamString(create_byRaw2)
		if create_byErr2 != nil {
			return errorResponse(request, http.StatusBadRequest, "QUERY_BAD_PARAM", fmt.Sprintf("invalid value for create_by2: %v", create_byErr2), nil)
		}
		skVal2 := TestGSI3SK{
			Shape:    shapeVal2,
...
func (h *Handler) HandleQueryByState(ctx context.Context, request protosource.Request) protosource.Response {
	ctx, err := h.authorizer.Authorize(ctx, request, "example.app.test.v1.QueryByState")
	if err != nil {
		return authzErrorResponse(request, err)
	}
